class CNN_XRayChest(object):
    ...
    def open_CSV(self):
        ...
        with open('/content/BBox_List_2017.csv', newline='') as csvfile:
    ...
    def predict(self):
        ...
        imgs = self.img_data[0:4]

        predictions = self.model.predict_classes(imgs)
        print(self.imagens[0:4])
        print(self.labels[0:4])
        print(predictions)
