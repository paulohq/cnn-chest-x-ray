...
class CNN_XRayChest(object):
    def __init__(self):
        ...
        #self.data_path = self.PATH + '/data-bbox'
    ...
    def augmenting_dataset(self):
        ...
        lbl_flip = self.Y[:450]
        lbl_flip1 = self.Y[:450]
        lbl_flip2 = self.Y[:450]
